...
void Init_rspike() {
	rb_cRSpike = rb_define_class("RSpike", rb_cObject);
	rb_define_alloc_func(rb_cRSpike, rspike_allocate);
	rb_define_method(rb_cRSpike, "set_spike", rb_set_spike, 0);
	rb_define_method(rb_cRSpike, "init_fuzz", rb_init_fuzzing, 0);
	rb_define_method(rb_cRSpike, "didlastvar?", rb_didlastvariable, 0);
	rb_define_method(rb_cRSpike, "reset_fuzzstr", rb_reset_fuzzstring, 0);
	rb_define_method(rb_cRSpike, "inc_fuzzvar", rb_increment_fuzzvar, 0);
	rb_define_method(rb_cRSpike, "inc_fuzzstr", rb_increment_fuzzstring, 0);
	rb_define_method(rb_cRSpike, "didlastfuzzstr?", rb_didlastfuzzstring, 0);	
	rb_define_method(rb_cRSpike, "clear", rb_spikeclear, 0);
	rb_define_method(rb_cRSpike, "connect_tcp", rb_connect_tcp, 2);
	rb_define_method(rb_cRSpike, "readline", rb_readline, 0);
	rb_define_method(rb_cRSpike, "parse", rb_parse, 1);
	rb_define_method(rb_cRSpike, "close_tcp", rb_close_tcp, 0);
	rb_define_method(rb_cRSpike, "send_lines", rb_send_lines, 0);
	rb_define_method(rb_cRSpike, "string", rb_string, 1);
	rb_define_method(rb_cRSpike, "blocksize_str", rb_blocksize_string, 2);
	rb_define_method(rb_cRSpike, "binary", rb_binary, 1);
	rb_define_method(rb_cRSpike, "push", rb_push, 2);
	rb_define_method(rb_cRSpike, "need_reserved", rb_set_needreserved, 1);
	rb_define_method(rb_cRSpike, "block_start", rb_block_start, 1);
	rb_define_method(rb_cRSpike, "binary_block_size_word_bigendian", rb_binary_block_size_word_bigendian, 1);
	rb_define_method(rb_cRSpike, "block_end", rb_block_end, 1);
	rb_define_method(rb_cRSpike, "print_buf", rb_print_buffer, 0);
	rb_define_method(rb_cRSpike, "printf_buf", rb_printf_buffer, 0);
	rb_define_method(rb_cRSpike, "get_size", rb_get_size, 0);
	rb_define_method(rb_cRSpike, "get_databuf", rb_get_databuf, 0);
	rb_define_method(rb_cRSpike, "send", rb_spike_send, 0);
	rb_define_method(rb_cRSpike, "send_tcp", rb_send_tcp, 2);
	rb_define_method(rb_cRSpike, "bigword", rb_bigword, 1);
	rb_define_method(rb_cRSpike, "binary_block_size_word_bigendian_plus", rb_binary_block_size_word_bigendian_plussome, 2);
	rb_define_method(rb_cRSpike, "binary_block_size_byte_mult", rb_binary_block_size_byte_mult, 2);
	rb_define_method(rb_cRSpike, "binary_block_size_word_bigendian_mult", rb_binary_block_size_word_bigendian_mult, 2);
	rb_define_method(rb_cRSpike, "binary_block_size_word_intel_mult_plus", rb_binary_block_size_word_intel_mult_plus, 3);
	rb_define_method(rb_cRSpike, "binary_block_size_intel_halfword_mult", rb_binary_block_size_intel_halfword_mult, 2);
	rb_define_method(rb_cRSpike, "xdr_string", rb_xdr_string, 1);
	rb_define_method(rb_cRSpike, "binary_repeat", rb_binary_repeat, 2);
	rb_define_method(rb_cRSpike, "string_repeat", rb_string_repeat, 2);
	rb_define_method(rb_cRSpike, "string_lf", rb_string_lf, 1);
	rb_define_method(rb_cRSpike, "ioal", rb_ioal, 1);
	rb_define_method(rb_cRSpike, "ioas", rb_ioas, 1);
	rb_define_method(rb_cRSpike, "intel_order", rb_intel_order, 2);
	rb_define_method(rb_cRSpike, "rb_intelword", rb_intelword, 1);
	rb_define_method(rb_cRSpike, "intelhalfword", rb_intelhalfword, 1);
	rb_define_method(rb_cRSpike, "binary_block_size_intel_halfword", rb_binary_block_size_intel_halfword, 1);
	rb_define_method(rb_cRSpike, "binary_block_size_halfword_bigendian", rb_binary_block_size_halfword_bigendian, 1);
	rb_define_method(rb_cRSpike, "binary_block_size_intel_halfword_plus", rb_binary_block_size_intel_halfword_plus, 2);
	rb_define_method(rb_cRSpike, "binary_block_size_byte", rb_binary_block_size_byte, 1);
	rb_define_method(rb_cRSpike, "binary_block_size_byte_plus", rb_binary_block_size_byte_plus, 2);
	rb_define_method(rb_cRSpike, "tcp_accept", rb_tcp_accept, 1);
	rb_define_method(rb_cRSpike, "close_udp", rb_close_udp, 0);
	rb_define_method(rb_cRSpike, "fd_wait", rb_fd_wait, 0);
	rb_define_method(rb_cRSpike, "fd_clear", rb_fd_clear, 0);
	rb_define_method(rb_cRSpike, "string_or_env", rb_string_or_env, 2);
	rb_define_method(rb_cRSpike, "string_variables", rb_string_variables, 2);
	rb_define_method(rb_cRSpike, "string_variable", rb_string_variable, 1);
	rb_define_method(rb_cRSpike, "reset_fuzzvariable", rb_reset_fuzzvariable, 0);
	rb_define_method(rb_cRSpike, "setfirstvariable", rb_setfirstvariable, 0);
	rb_define_method(rb_cRSpike, "scan_for_variable", rb_scan_for_variable, 3);
	rb_define_method(rb_cRSpike, "getcurrentspike", rb_getcurrentspike, 0);
	rb_define_method(rb_cRSpike, "get_spike_fd", rb_get_spike_fd, 0);
	rb_define_method(rb_cRSpike, "set_unicode", rb_set_unicode, 1);
	rb_define_method(rb_cRSpike, "update_listeners", rb_update_listeners, 1);
	rb_define_method(rb_cRSpike, "read_packet", rb_read_packet, 0);
	rb_define_method(rb_cRSpike, "get_max_fuzzstring", rb_get_max_fuzzstring, 0);
	rb_define_method(rb_cRSpike, "get_fuzzstring", rb_get_fuzzstring, 1);
	rb_define_method(rb_cRSpike, "get_random_fuzzstring", rb_get_random_fuzzstring, 0);
	rb_define_method(rb_cRSpike, "read_bigendian_word_packet", rb_read_bigendian_word_packet, 1);
	rb_define_method(rb_cRSpike, "cstring", rb_cstring, 1);
	rb_define_method(rb_cRSpike, "unistring", rb_unistring, 1);
}
